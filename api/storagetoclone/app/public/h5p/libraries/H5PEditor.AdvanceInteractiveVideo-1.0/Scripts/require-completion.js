/**
 * @class H5PEditor.AdvanceInteractiveVideo.RequireCompletion
 */
H5PEditor.AdvanceInteractiveVideo.RequireCompletion = (function () {

  /**
   * Handles the require completion option and the way it affects the interaction
   * and other interactions.
   *
   * @param {H5PEditor.AdvanceInteractiveVideo} IVEditor
  ...
  function RequireCompletion(IVEditor, interaction) {
    ...
    var t = H5PEditor.AdvanceInteractiveVideo.t;
