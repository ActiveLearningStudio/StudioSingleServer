!(function (t) {
  ...
  function (t, e, n) {
    ...
    (H5P = H5P || {}), (H5P.AdvanceInteractiveVideo = i.default);
  },
  function (t, e) {},
  function (t, e) {},
  function (t, e) {},
        ...
        B = function (n) {
          (h = r("<div/>", {
            ...
            o.getRequiresCompletion() &&
              void 0 === e.editor &&
              e.currentState !== H5P.AdvanceInteractiveVideo.SEEKING &&
              L(!0),
      ...
      (o.setDnbElement = function (t) {
            ...
            if (void 0 !== n) {
              ...
              return (
                ...
                i.setLabel(
                  T +
                    " " +
                    H5P.AdvanceInteractiveVideo.humanizeTime(t.duration.from) +
                    " - " +
                    H5P.AdvanceInteractiveVideo.humanizeTime(t.duration.to)
                ),
                i
              );
            }
        ...
        (o.getClipboardData = function () {
          return H5P.DragNBar.clipboardify(
            H5PEditor.AdvanceInteractiveVideo.clipboardKey,
            t,
            "action"
          );
        }),
              ...
              value: function (t, e, n, o) {
                ...
                return (
                  ...
                  c("<div/>", {
                    ...
                    html: H5P.AdvanceInteractiveVideo.humanizeTime(t),
                    appendTo: d,
                    "aria-hidden": !0,
                  }),
                  c("<div/>", {
