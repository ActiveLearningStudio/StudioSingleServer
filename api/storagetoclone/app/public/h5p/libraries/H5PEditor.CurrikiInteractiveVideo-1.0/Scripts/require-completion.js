/**
 * @class H5PEditor.CurrikiInteractiveVideo.RequireCompletion
 */
H5PEditor.CurrikiInteractiveVideo.RequireCompletion = (function () {

  /**
   * Handles the require completion option and the way it affects the interaction
   * and other interactions.
   *
   * @param {H5PEditor.CurrikiInteractiveVideo} IVEditor
  ...
  function RequireCompletion(IVEditor, interaction) {
    ...
    var t = H5PEditor.CurrikiInteractiveVideo.t;
