/**
 * @class H5PEditor.BrightcoveInteractiveVideo.RequireCompletion
 */
H5PEditor.BrightcoveInteractiveVideo.RequireCompletion = (function () {

  /**
   * Handles the require completion option and the way it affects the interaction
   * and other interactions.
   *
   * @param {H5PEditor.BrightcoveInteractiveVideo} IVEditor
  ...
  function RequireCompletion(IVEditor, interaction) {
    ...
    var t = H5PEditor.BrightcoveInteractiveVideo.t;
